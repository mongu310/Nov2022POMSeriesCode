...
public class ProductInfoPage {
	...
	public ProductInfoPage(WebDriver driver) {	
		...
		public String addProductToCart() {
			...
			String successMessge = eleUtil.waitForElementVisible(cartSuccessMessg, AppConstants.DEFAULT_SHORT_TIME_OUT).getText();
			
			//testing
			//testin
			StringBuilder sb = new StringBuilder(successMessge);
			String mesg = sb.substring(0, successMessge.length()-1).replace("\n", "").toString();
